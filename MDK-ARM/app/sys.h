...
#define GIMBAL_PC_MOVE_RATIO_PIT			2.0f		//biger = move faster, 1.0f = 100%
#define GIMBAL_PC_MOVE_RATIO_YAW			1.0f		//biger = move faster, 1.0f = 100%
/*================ GIMBAL MOVE SPEED RATIO ==================*/


/*================ GIMBAL MOVE POSITION LIMIT ==================*/
#define YAW_MOVE_RANGE	 200 	//from center(aka.0)， also = [center-RANGE, center+RANGE], total = 8192
#define PIT_MOVE_UP			550
#define PIT_MOVE_DOWN		100
/*================ GIMBAL MOVE POSITION LIMIT ==================*/


/*================ GIMBAL SHOT PART PARAM ==================*/
#define POKE_MOTOR_SPEED							2000	//biger = faster
#define SHOT_FRIC_WHEEL_SPEED					1320		//biger = faster, max = 2000
/*================ GIMBAL SHOT PART PARAM ==================*/
